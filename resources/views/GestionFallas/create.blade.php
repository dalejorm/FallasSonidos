    ...
    <div id='recipients' class="static p-8 mt-6 mx-6 rounded shadow  bg-white">
        ...
        <div class="rounded-t-lg overflow-hidden border border-l border-r border-gray-400 flex justify-center p-8">
            ...
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3  mb-6 md:mb-0">
                {{-- codigoVIN --}}                    
                    <x-jet-label class="inline-block mb-4" for="codigoVIN" value="codigo_vin" /><span class="inline-block text-red-500">*</span>
                    <x-jet-input id="codigo_vin" name="codigo_vin" class="block w-full" type="text" value="{{old('codigo_vin')}}" placeholder="código VIN" data-error="" minlength="4" maxlength="190"/>
                    <x-jet-input-error for="codigo_vin" class="mt-2"  required/>  
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="rounded-t-lg overflow-hidden border border-l border-r border-gray-400 flex justify-center p-8">                            
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <x-jet-label class="inline-block mb-4 text-sm font-medium text-gray-900 dark:text-white" for="imagen_pieza" value="cargar imagen"/><span class="inline-block text-red-500">*</span>
                        <input  id="imagen_pieza" name="imagen_pieza" value="{{old('imagen_pieza')}}" class="block w-full appearance-none bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" type="file" accept=".jpg" required/>
