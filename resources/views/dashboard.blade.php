        ...
        <div class="pt-6 max-w-7xl lg:w-11/12 mx-auto p-8 mt-6">
            ...
            <x-welcome />  
                                ...
                                <div class="max-w-full">
                                    <div class="flex">
                                        <div class="flex-1 max-w-80">
                                            <input class="w-full rounded-l-full rounded-r-none appearance-none block bg-white text-gray-400  drop-shadow-xl rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white border-b-4 border-gray-500 hover:border-gray-500" minlength="3" maxlength="50" id="txt-search" name="txt-search" type="text" pattern="[a-zA-Z0-9 ]{3,50}" title="Ingrese texto a buscar" placeholder="Buscar registro de falla y ruido" >
                                        </div>
                                        <div class="flex-1 max-w-20">
                                            <button type="submit" class="rounded-r-full rounded-l-none inline-flex items-center py-2.5 px-3 ml-1  bg-blue-500 hover:bg-blue-400 text-white font-bold border-b-4 border-blue-700 hover:border-blue-500 rounded drop-shadow-xl"> <svg class="mr-2 -ml-1 w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" ></path></svg>Buscar</button>
                                            </div>
                                    </div>
                ...
                <div class="bg-gray-300 bg-opacity-50 grid grid-cols-1 md:grid-cols-3">
                    ...
                    <div class="p-6 ">
                        <div class="max-w-sm rounded overflow-hidden shadow-lg bg-white">
                            <div class="container min-w-100px w-auto max-w-900 mx-auto mt-20">
                                <div class="card flex flex-col items-center bg-gradient-to-r from-[#36A9E1] from-10% via-white via-50% to-[#36A9E1] to-10%... p-4 rounded-md b-4 text-black " >                               <div class="cover flex flex-col items-center min-w-80px w-auto max-w-880px">
                                <div class="font-bold text-xl mb-2"><a href="{{ route('gestion-fallas.show', [$res]) }}">{{$res->nombre_falla}}</a></div>
                                </div>
                                    <audio class="block w-full max-w-md mx-auto border-1 border-gray-400" controls>
                            ...
                            <div class="px-6 pt-4 pb-2">
                                <span class="inline-block bg-[#FBB06A] rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#{{$res->modelo}}</span>
                                <span class="inline-block bg-[#36A9E1] rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#{{$res->marca}}</span>
                                <span class="inline-block bg-gray-300 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#{{$res->sistema_falla}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="pointer-events-auto fixed bottom-0 left-0 mb-12 ml-5 mx-auto w-96 max-w-full rounded-lg bg-warning-100 bg-clip-padding text-sm text-warning-700 shadow-lg shadow-black/5 data-[te-toast-show]:block data-[te-toast-hide]:hidden" role="alert" aria-live="assertive" aria-atomic="true" data-te-autohide="false" data-te-toast-init data-te-toast-show style="z-index: 99999;">
                        ...
                        <div class="break-words rounded-b-lg bg-warning-100 px-4 py-4 text-warning-700">
